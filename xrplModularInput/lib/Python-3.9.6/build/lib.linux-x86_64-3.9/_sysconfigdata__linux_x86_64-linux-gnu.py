...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/opt/splunk/etc/apps/xrplModularInput/lib/Python-3.9.6/coverage.info',
 'COVERAGE_REPORT': '/opt/splunk/etc/apps/xrplModularInput/lib/Python-3.9.6/lcov-report',
 ...
 'abs_builddir': '/opt/splunk/etc/apps/xrplModularInput/lib/Python-3.9.6',
 'abs_srcdir': '/opt/splunk/etc/apps/xrplModularInput/lib/Python-3.9.6',
